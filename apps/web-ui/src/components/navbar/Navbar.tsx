...
export const Navbar = () => {
  const { refresh, btcPrice, change: btcChangePrice, loading } = useBtcPrice();
  ...
  const priceToShow = netAssetValue ? data.totalValue : btcPrice;
      ...
      >
          ...
          >
            <Button variant="ghost">
              <Text size="6" color="orange" onClick={toggleBalance}>
                {ui.balanceVisible ? padBtcZeros(data.totalBalance) : "My "} BTC
              </Text>
            </Button>
          </div>
          <div></div>
        ...
        <div className="border border-b-0 border-x-0 ">
          <div
            ...
            className="md:container flex justify-between px-2 text-gray-400 py-2"
          >
            <div className="flex">
              <div className="flex items-center">
