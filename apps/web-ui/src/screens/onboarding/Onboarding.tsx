...
export const Onboarding = () => {
  const { actions } = useWallet([VITE_TOSHI_MOTO_XPUB]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-2 md:px-0 mb-4">
            ...
            <div className="px-2">
              <Blockquote>
                ...
                <ul className="list-disc list-inside mt-2 ml-4">
                  ...
                  <li>
                    <Text>
                      <b>Transparency</b> - I intend to publish all source code
                      to a Github repo for review. However, I am currently
                      undecided as to which type of license to allow, and am
                      beginning with creative commons. This means it is not open
                      source and I may intend to commercialize it at some point
                      in the future.
                    </Text>
                  </li>
                  <li>
        ...
        <div className="py-2 px-4 border rounded bg-white drop-shadow-lg">
          ...
          <div className="py-4 flex flex-col">
            ...
            <div className="mb-2">
              <TextField.Input disabled defaultValue={VITE_TOSHI_MOTO_XPUB} />
            </div>
            <div className="mb-2">
              <Text>
